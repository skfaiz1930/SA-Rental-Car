...
/**
 * Function to create a PDF document with invoice details.
 * 
 * @param {Object} data - Invoice data including username, amount, rental days, card number, and payment date.
 * @returns {Promise<Buffer>} - A promise that resolves to the generated PDF data.
 */
