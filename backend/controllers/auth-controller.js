 ...
 * @description Handles customer and admin login functionalities.
 */
...
/**
 * Logs in a customer by verifying their username and password.
 * Generates a JWT and sends it as an HTTP-only cookie.
 *
...
/**
 * Logs in an admin by verifying their username, password, and employee ID.
 * Generates a JWT and sends it as an HTTP-only cookie.
 *
 * @param {Object} req - The request object containing login credentials.
 * @param {Object} res - The response object for sending back results.
