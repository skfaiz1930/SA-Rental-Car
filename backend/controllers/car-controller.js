 ...
 * @description Handles car-related operations including adding, updating, deleting, and retrieving cars.
 */
 ...
 * 
 * @param {Object} req - The request object containing car details.
...
/**
 * Controller function to get all cars, with an optional category filter.
 * 
 * @param {Object} req - The request object containing query parameters.
 * @param {Object} res - The response object for sending back results.
 * @returns {Array} - A JSON response containing the list of cars.
 */
...
/**
 * Controller function to update a car's details.
 * 
 * @param {Object} req - The request object containing the updated car details.
 * @param {Object} res - The response object for sending back results.
 * @returns {Object} - A JSON response indicating success or failure.
 */
 ...
 * 
 * @param {Object} req - The request object containing the car ID to delete.
 * @param {Object} res - The response object for sending back results.
 * @returns {Object} - A JSON response indicating success or failure.
 */
...
/**
 * Controller function to get all distinct car locations.
 * 
 * @param {Object} req - The request object.
 * @param {Object} res - The response object for sending back results.
 * @returns {Array} - A JSON response containing distinct locations.
 */
...
/**
 * Controller function to get categories available in a specific location.
 * 
 * @param {Object} req - The request object containing the location.
 * @param {Object} res - The response object for sending back results.
 * @returns {Array} - A JSON response containing the list of categories.
 */
...
/**
 * Function to check if a car is available for a specific date range.
 * 
 * @param {Object} car - The car object to check availability.
 * @param {String} fromDate - The start date of the rental.
 * @param {String} toDate - The end date of the rental.
 * @returns {Boolean} - Returns true if the car is available, otherwise false.
 */
...
/**
 * Controller function to filter cars by location, category, budget, and availability.
 * 
 * @param {Object} req - The request object containing query parameters.
 * @param {Object} res - The response object for sending back results.
 * @returns {Array} - A JSON response containing the filtered list of cars.
 */
...
/**
 * Controller function to fetch car details by carId.
 * 
 * @param {Object} req - The request object containing the car ID.
 * @param {Object} res - The response object for sending back results.
 * @returns {Object} - A JSON response containing the car details.
 */
...
/**
 * Controller function to check availability and book a car.
 * 
