...
/**
 * CarDetailsPage component fetches and displays detailed information about a specific car.
 * The component retrieves the car details from the backend using the carId from the URL parameters.
 * It also provides a back button to navigate to the previous page.
 *
 * @component
 * @returns {JSX.Element} - The rendered CarDetailsPage component.
 */
const CarDetailsPage = () => {
  ...
  /**
   * Fetches the car details from the server when the component mounts.
   * It sends a GET request to the backend API with the carId.
   *
   * @async
