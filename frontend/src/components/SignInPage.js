...
/**
 * SignInPage component handles the sign-in process for both customers and admins.
 * It allows users to switch between customer and admin sign-in, enter their credentials,
 * and submit the data to the appropriate API endpoint.
 ...
 * @param {Function} props.setUserRole - Function to set the user's role (customer or admin).
 * @param {Function} props.setUsername - Function to set the username in the parent component.
...
const SignInPage = ({ isLoggedIn, setIsLoggedIn, setUserRole, setUsername }) => {  
     ...
     * Sends a POST request to the appropriate endpoint based on the sign-in type.
     * Updates the global login state and navigates to the previous or target page upon success.
     *
    ...
    /**
     * Handles navigation to the registration page based on the sign-in type.
     * Redirects to the respective registration page for customers or admins.
     */
     ...
     * Resets the login state and navigates to the home page.
     */
    const handleLogout = () => {
