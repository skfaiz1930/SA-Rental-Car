    ...
    <div className="homepage">
      <main>
        <section className="welcome-section">
          <h1>Welcome to SA Rental Car</h1>
          <p>SA Rental Car offers you the freedom to travel in comfort and style. Choose from our wide range of vehicles for your next adventure.</p>
          <a href="#explore">Explore Our Fleet</a>
        </section>
          ...
          {onSaleCars.length > 0 ? (
            <div key={onSaleCars[currentCarIndex]._id} className="car-item">
              ...
              <div className="car-details">
                ...
                <p className="old-price">Old Price:{onSaleCars[currentCarIndex].oldPrice} $</p>
            ...
            <div className="car-list">
              {filteredCars.map((car) => (
                <div key={car._id} className="car-item">
                  ...
                  <div className="car-details">
                    <h3>{car.name}</h3>
                    {/* Show price logic based on sale */}
                    {car.oldPrice ? (
                      <>
                        <p className="old-price">Old Price: ${car.oldPrice}</p>
                        <p className="price">Sale Price: ${car.price}</p>
                      </>
                    ) : (
